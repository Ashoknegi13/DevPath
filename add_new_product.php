...
/*				background-color: tan;*/
	...
	<form action="add_new_product_in_db.php" method="POST" enctype="multipart/form-data" autocomplete="off">
		...
		<tr>
			...
			<td><input type="text" placeholder="Course title" name="course_title"
				required style="padding: 5px;"></td>
		</tr>

		<tr>
			<td><label for="">Course Discription :</label></td>
			<td><textarea  type="text" placeholder="Discription" name="course_discription" required style="padding: 5px; border-radius: 40PX;"> </textarea></td>
		</tr>
		...
		<tr>
			...
			<td><textarea  placeholder="prerequisites" name="prerequisites" required style="padding: 5px;border-radius: 40PX;"></textarea></td>
		</tr>
		
		<tr>
			<td><label for="">Course Content : </label></td>
			<td><textarea type="text" placeholder="Content" name="course_content" required style="padding: 5px;border-radius: 40PX;"></textarea></td>
		</tr>
		...
		<tr>
			...
			<td><textarea type="text" placeholder="course Meterials" name="course_meterials" required style="padding: 5px;border-radius: 40PX;"></textarea></td>
		</tr>
		...
		<tr> <td></td>
			<td>
				<button name="add_newbtn" style="background: green; color:white; border-radius: 50px;" >Sumbit</button>
			</td>
			...
			<button style="background: cyan; border-radius:50px"><a style="text-decoration: none;color: black;" href="getdata.php">Home page</a></button>
	</body>
</html>
