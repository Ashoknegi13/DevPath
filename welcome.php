...
<html>
	...
	<form action="welcome.php" method="POST" autocomplete="off">	
	 ...
	 <h3 style="color:white;">Dont't Have any account Press <b>	--> </b><button style="background:cyan; border-radius: 20px;width: 90px;height: 40px;"><a href="signup.php" style="text-decoration:none; color:black;">Sign Up</a></button></h3>
