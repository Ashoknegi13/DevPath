...
<html>
	...
	<body>
		...
		<header>
	 <ul>
		<li><h1>Welcome Section </h1></li>
		</header> 
				<b>Headline :</b>"Empowering Your Coding Journey"				
			 
			<p><b>Discription : </b>
				" Welcome to  <u style="color:red">DevPath</u> your gateway to mastering programming skills! We believe that coding is for everyone , and our plateform is designed to make learniing both accessible and enjoyable to make learning both accessibl eand enjoyable for beginners and professionals alike ".
			</p>

			<h1><li> Mission Statement </li></h1>
				
			<p>
				" our mission is to provide high-qualit, affordable , and practical programming courses that help you build real-world skills and achieve your carrer goals."
			</p>

			<h2><li>What We Offer </li></h2>
			<ul>
				...
				<li><strong>Customer Focus : </strong>We belive in being transparent and honest with our clients and parteners.</li>
