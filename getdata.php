...
<div id="search-bar" style="margin-left: 900px;">
	...
	<input type="Search" id="search" placeholder="search username" autocomplete="off"
...
<h2 style="text-align:center; color: white;">"Welcome,
	...
	</u>! Let's Unlock the World of Knowledge!"
</h2><br>
...
<body>
	<table border="1px solid black" cellpadding="5px" cellspacing="0px " style="margin-left: 50px;">
		...
		<tr>
			...
			<td>
				...
				<img src="upload-image/<?php echo $row['file']; ?> "
					style="width: 50px; height: 50px;  margin-left:30px; border-radius:50px; border: 1px solid black ">
				<?php
				}
				?>
			<td>
			...
			<td><button style="background:green;width: 70px"><a id="edit-btn"
						style=" text-decoration: none; color:  white; "
						href="update.php?id=<?php echo $row['id']; ?>">edit</a></button></td>
			<td><button style="background:red;width: 70px"><a style="color: white; text-decoration: none;"
						href="delete-inline.php?id=<?php echo $row['id']; ?>">delete</a></button></td>
		</tr>
		<?php
			}
		}
	...
	<br><br>
	<h3 align="center" style="color:white;"> "Success Starts Here - Choose a Course and Get Started!" </h3>
	...
	<table border="1px solid black" cellpadding="5px" cellspacing="0px" style="margin-left:200px;">
		...
		<tr>
			...
			<td><a style="color: white ; text-decoration: none;font-size: 14px"
					href="course.php?id=<?php echo $row['product_id']; ?>">Details..</a></td>

			<td><button style="background: blue;width: 70px"><a style="color:white; text-decoration:none;"
						href="edit_product.php?id=<?php echo $row['product_id']; ?>">edit</a></button></td>

			<td><button style="background: red;width: 70px"><a style="color:white; text-decoration:none;"
						href="delete_product.php?id=<?php echo $row['product_id']; ?>">delete<a /></button></td>

			<td><button style="background: lightgreen;width: 70px;"><a
						style="color:black; text-decoration:none; font-size: 12px;  "
						href="buy_course.php?id=<?php echo $row['product_id']; ?>">Buy</a></button></td>
			...
			<td>
				<form action="insert-cart-data.php" method="POST">
					...
					<input type="submit"
						style="background:green;border-radius: 30px; color:white;width: 60px;cursor: pointer;"
						id="add_to_cart" value="add" name="add_to_cart_btn">
				</form>
			</td>
	...
	<button style=" background:cyan; margin-left: 420px;width: 300px;height:50px;"><a
			style="font-size:20px;text-decoration:none; color:black;" href="add_new_product.php">ADD NEW
			PRODUCTS</a></button>
	<button style=" background:cyan;width: 300px;height:50px;"><a
			style="text-decoration:none; color:black;font-size:20px" href="sell_product.php">Show all sell
			products</a></button>
	...
	<table border="1px solid black" cellpadding="5px" cellspacing="0px " style="margin-left: 230px;">
		...
		<tr>
			...
			<td><button style="background:green;width: 70px;">
					<?php
					...
					<a style=" text-decoration: none; color:  white; "
						href="update.php?id=<?php echo $row['id']; ?>">edit</a>
				</button></td>
			<?php
					}
					?>
	...
	<table border="1px solid black" cellpadding="5px" cellspacing="0px" style="margin-left: 220px;">
		...
		<tr>
			...
			<td><button style="background:  green;width: 70px;"><a style="text-decoration:none;color: white;"
						href="edit_product.php?id=<?php echo $row['product_id']; ?>">edit</a></button></td>
			<td><button style="background: blue;width: 70px;"><a style="text-decoration:none;color: white;"
						href="buy_course.php?id=<?php echo $row['product_id']; ?>">Buy</a></button></td>
	...
	<hr><br>
	<button style=" background:cyan; margin-left: 350px;width: 300px;height:50px"><a
			style="text-decoration:none; color:black;font-size: 20px;" href="add_new_product.php">ADD NEW
			PRODUCTS</a></button>
	<button style=" background:cyan;width: 300px;height:50px"><a
			style="text-decoration:none; color:black;font-size: 20px" href="sell_product.php">Show all sell
			products</a></button>
...
elseif ($_SESSION['usertype'] == 'normal') {
	...
	<table border="1px solid black" cellpadding="5px" cellspacing="0px" style="margin-left: 250px;">
		...
		<tr>
			...
			<td><a href="course.php?id=<?php echo $row['product_id']; ?>">Click here</a></td>
			<td><button style="background:green;width: 80px;"><a style="text-decoration: none;color:white"
						href="buy_course.php?id=<?php echo $row['product_id']; ?>">Buy</a></button></td>
			...
			<td>
				<form action="insert-cart-data.php" method="POST">
					...
					<input type="number" name="quantity" id="quantity" value="1" style="width:40px">
					<input type="submit"
						style="background:green;border-radius: 30px; color:white;cursor:pointer;width: 60px;"
						id="add_to_cart" value="add" name="add_to_cart_btn">
				</form>
			</td>
	...
	<hr>
	<button style="background:cyan; margin-left: 420px;width: 300px;height:50px"><a
			style="font-size:20px;color:black; text-decoration:none;" href="sell_product.php">Show all sell
			products</a></button>
