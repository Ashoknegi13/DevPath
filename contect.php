...
<head>
	...
	<body>
		...
		?>
		<header>
		<h1>This is our Contect Information</h1>
		</header> 
		...
		<section id="about">
			...
			<ul>
				...
				<li><strong>Email-id : </strong>negiashok132@gmail.com  </li>
				<li><strong>Instagram-id : </strong>@ashoknegi_13</li>
				<li><strong>Whatsapp Bussiness group   : </strong>9045509148.</li>
